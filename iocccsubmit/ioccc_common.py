...
#
VERSION_IOCCC_COMMON = "2.9.9 2026-08-26"
...
STATIC_DIR_RELATIVE_PATH = "static"

# Absolute path resolutions (as Path objects)
#
PW_FILE = str(APPDIR / PW_FILE_RELATIVE_PATH)
INIT_PW_FILE = str(APPDIR / INIT_PW_FILE_RELATIVE_PATH)
PW_LOCK = str(APPDIR / PW_LOCK_RELATIVE_PATH)
ADM_FILE = str(APPDIR / ADM_FILE_RELATIVE_PATH)
SECRET_FILE = str(APPDIR / SECRET_FILE_RELATIVE_PATH)
USERS_DIR = str(APPDIR / USERS_DIR_RELATIVE_PATH)
STATE_FILE = str(APPDIR / STATE_FILE_RELATIVE_PATH)
INIT_STATE_FILE = str(APPDIR / INIT_STATE_FILE_RELATIVE_PATH)
STATE_FILE_LOCK = str(APPDIR / STATE_FILE_LOCK_RELATIVE_PATH)
PW_WORDS = str(APPDIR / PW_WORDS_RELATIVE_PATH)
TEMPLATES_DIR = str(APPDIR / TEMPLATES_DIR_RELATIVE_PATH)
STATIC_DIR = str(APPDIR / STATIC_DIR_RELATIVE_PATH)
