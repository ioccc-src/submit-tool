...
To report a security issue, click on: "[Open a draft security advisory](https://github.com/ioccc-src/submit-tool/security/advisories/new)"
...
Version: IOCCC28.2 (package version 2.3.1) and later.
